 ...
 */
public class BluetoothCoordinateService extends Service {
    // Debugging
    private static final String TAG = "BluetoothChatService";

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = "BluetoothCoordinateSecure";
    private static final String NAME_INSECURE = "BluetoothCoordinateInsecure";
     ...
     */
    public BluetoothCoordinateService(Context context, Handler handler) {
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        ...
        MY_UUID_SECURE = device.getUuids()[0].getUuid();
        MY_UUID_INSECURE = device.getUuids()[0].getUuid();
        // Cancel any thread attempting to make a connection
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (BluetoothCoordinateService.this) {
                mConnectThread = null;
            }
                ...
                try {
                    ...
                    if (!s.hasNextLine()) {
                        ...
                        if (line.contains(ADDR_ANCH_1) || line.contains(ADDR_ANCH_2) || line.contains(ADDR_ANCH_3)) {        // exception case
                            ...
                            Log.d(this.toString(),"Invalid anchor distance packet: " + line);
                        }
                    }
